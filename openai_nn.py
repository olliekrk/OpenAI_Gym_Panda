...
https://github.com/abhavk/dqn_from_scratch
...
frames_imgs = [Image.fromarray(f) for f in frames]
frames_imgs[0].save("car_nn.gif", save_all=True, append_images=frames_imgs[1:], duration=20, loop=0)